      ...
      <Tabs className="main-modal-container">
        <TabList className="tab-list">
          <Tab selectedIndex={tabIndex} className="modal-info-icon" onSelect={tabIndex => setTabIndex({ tabIndex })}>
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" className="modal-svg">
          ...
          <Tab selectedIndex={tabIndex} className="modal-info-icon" onSelect={tabIndex => setTabIndex({ tabIndex })}>
            <svg version="1.1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" stroke="currentColor"  className="modal-svg">
